...
Term.prototype.run = function(connection, options, callback) {
  ...
  if (!!self._error) {
    var error = new errors.ReqlRuntimeError(self._error, self._query, {b: self._frames});
          ...
          helper.loopKeys(options, function(options, key) {
            if (keepGoing === true) {
              if ((key === 'readMode') || (key === 'durability') || (key === 'db') ||
                ...
                setTimeout(function() {
                  reject(new errors.ReqlDriverError('Unrecognized option `' + key + '` in `run`. Available options are readMode <string>, durability <string>, noreply <bool>, timeFormat <string>, groupFormat: <string>, profile <bool>, binaryFormat <string>, cursor <bool>, stream <bool>'));
                }, 0);
...
function Func(r, func) {
  ...
  if (body === undefined) throw new errors.ReqlDriverError('Annonymous function returned `undefined`. Did you forget a `return`? In:\n' + func.toString(), this._query);
