...
error.createRuntimeError = function(type, message, query, frames) {
  switch (type) {
    ...
    case protoErrorType.RESOURCE:
      return new error.ReqlResourceError(message, query, frames);
    case protoErrorType.LOGIC:
      return new error.ReqlLogicError(message, query, frames);
 ...
 *
 */
error.ReqlResourceError = function(message, query, frames) {
  error.ReqlRuntimeError.call(this, message, query, frames);
  this.name = 'ReqlResourceError';
};
util.inherits(error.ReqlResourceError, error.ReqlRuntimeError);

/**
 *
 */
error.ReqlLogicError = function(message, query, frames) {
  error.ReqlRuntimeError.call(this, message, query, frames);
  this.name = 'ReqlLogicError';
};
util.inherits(error.ReqlLogicError, error.ReqlRuntimeError);
